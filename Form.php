	...
	<script src="js/lunch_menu.js"></script>
        ...
        <nav class="navbar navbar-custom, col-md-6" role="navigation">
           <ul class="lista nav nav-pills">  
                <li><a href="kokeiluja.htm"> <i class="fa fa-home fa-1x" > </i> Home </a></li>
...
<section>
 <a href=""><img src="img/banneri.jpg" alt=""/></a>
</section>
  ...
  <div class="heading">
	...
	<h2>Sign in</h2>
        ...
        <div class="input-group input-group-lg">
			...
			<button type="submit" name="Login" value="Submit" class="float">Login</button>
		</form>	
		
		</div>
		<div class="input-group input-group-lg">
	<a href='profile.php' class="span" >Click Here for your profile</a>
	<br>
	<a href='login.php?logout'  class="span" >Click here to log out</a>	
	</div>
 </div>
